...
FRONTEND_BASE_URL = os.getenv("FRONTEND_BASE_URL", "https://replyflow-mvp-backend.onrender.com")
...
def _compose_beta_welcome_body(name: str | None = None) -> str:
    ...
    base = FRONTEND_BASE_URL.rstrip('/') or "https://replyflow-mvp-backend.onrender.com"
