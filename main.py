...
# functionality (such as the Progressive Web App install) that may vary between
...
# environment variables. Currently only ENABLE_PWA controls whether the
# Progressive Web App installation instructions are shown in the welcome email.
...
def _compose_beta_welcome_body(name: str | None = None) -> str:
    ...
    # Step 3: Progressive Web App (PWA) installation instructions or placeholder based on flag.
    # Now that the browser extension is no longer offered, we renumber the PWA instructions to be step 3.
    if ENABLE_PWA:
        step3 = (
            "3. Install as a Progressive Web App (optional): On desktop, look for the install icon "
        ...
        step3 = (
            "3. Progressive Web App: Coming soon! We'll notify you when offline and install "
